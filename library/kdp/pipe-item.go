...
type PipeItem struct {
	...
	ReceiveScannerData bool            `kf-pos:"2,1" label:"Receive scanner data"`
	CollectProcess     bool            `kf-pos:"2,2" label:"Collect Process"`
	CloseWhenDone      bool            `kf-pos:"3,1" label:"Close if done"`
	CloseWhenFail      bool            `kf-pos:"3,2" label:"Close if fail"`
	Config             toolkit.M       `kf-pos:"4,1" kf-control:"json"`
